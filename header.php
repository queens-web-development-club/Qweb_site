  ...
  <header>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark z-1000" id="navbar">
        <a class="navbar-brand" href="#">
          <img src="/wp-content/themes/Qweb_site/media/logo.png" alt="Q web">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-2 my-lg-0">
            <a class="navbar-brand" href="https://facebook.com">
              <img src="/wp-content/themes/Qweb_site/media/facebook-icon.png" alt="Q web">
            </a>
            <a class="navbar-brand" href="https://instagram.com">
              <img src="/wp-content/themes/Qweb_site/media/insta-icon.png" alt="Q web">
            </a>
            <a class="navbar-brand" href="https://linkedin.com">
              <img src="/wp-content/themes/Qweb_site/media/linkedin-icon.png" alt="Q web">
            </a>
            <a class="navbar-brand" href="https://outlook.com">
              <img src="/wp-content/themes/Qweb_site/media/mail-icon.png" alt="Q web">
            </a>
...
<script src="/wp-content/themes/Qweb_site/scripts/header_effect.js"></script>
    <script>
